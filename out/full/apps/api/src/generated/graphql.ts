...
export type FrequencyUnit = 'day' | 'month' | 'week' | 'year';
...
export type PlanStatus = 'active' | 'archived' | 'paused';

export type PlanType = 'box' | 'prepaid' | 'standard';
...
export type BoxConfigResolvers<
  ContextType = GraphQLContext,
  ParentType extends ResolversParentTypes['BoxConfig'] =
    ResolversParentTypes['BoxConfig'],
> = ResolversObject<{
  allowSwaps?: Resolver<
  ...
  slots?: Resolver<
    Maybe<Array<ResolversTypes['BoxSlotConfig']>>,
    ParentType,
    ContextType
  >;
...
export type BoxItemResolvers<
  ContextType = GraphQLContext,
  ParentType extends ResolversParentTypes['BoxItem'] =
    ResolversParentTypes['BoxItem'],
> = ResolversObject<{
...
export type BoxSlotConfigResolvers<
  ContextType = GraphQLContext,
  ParentType extends ResolversParentTypes['BoxSlotConfig'] =
    ResolversParentTypes['BoxSlotConfig'],
> = ResolversObject<{
...
> = ResolversObject<{
  archivePlan?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationArchivePlanArgs, 'id'>
  >;
  cancelContract?: Resolver<
    ResolversTypes['SubscriptionContract'],
    ParentType,
    ContextType,
    RequireFields<MutationCancelContractArgs, 'id' | 'reason'>
  >;
  createPlan?: Resolver<
    ResolversTypes['SubscriptionPlan'],
    ParentType,
  ...
  >;
  customerCancelContract?: Resolver<
    ResolversTypes['SubscriptionContract'],
    ParentType,
    ContextType,
    RequireFields<MutationCustomerCancelContractArgs, 'contractId' | 'reason'>
  >;
  customerPauseContract?: Resolver<
    ResolversTypes['SubscriptionContract'],
    ParentType,
    ContextType,
    RequireFields<MutationCustomerPauseContractArgs, 'contractId' | 'duration'>
  >;
  customerSkipNextDelivery?: Resolver<
    ResolversTypes['SubscriptionContract'],
    ParentType,
    ContextType,
    RequireFields<MutationCustomerSkipNextDeliveryArgs, 'contractId'>
  >;
  customerSwapProduct?: Resolver<
    ResolversTypes['SubscriptionContract'],
    ParentType,
    ContextType,
    RequireFields<
      MutationCustomerSwapProductArgs,
      'contractId' | 'newProductId' | 'newVariantId'
    >
  >;
  customerUpdateBoxItems?: Resolver<
    ResolversTypes['SubscriptionContract'],
    ParentType,
    ContextType,
    RequireFields<MutationCustomerUpdateBoxItemsArgs, 'contractId' | 'items'>
  >;
  deletePlan?: Resolver<
    ResolversTypes['SubscriptionPlan'],
    ParentType,
    ContextType,
    RequireFields<MutationDeletePlanArgs, 'id'>
  >;
  pauseContract?: Resolver<
    ResolversTypes['SubscriptionContract'],
    ParentType,
    ContextType,
    RequireFields<MutationPauseContractArgs, 'duration' | 'id'>
  >;
  resumeContract?: Resolver<
    ResolversTypes['SubscriptionContract'],
    ParentType,
    ContextType,
    RequireFields<MutationResumeContractArgs, 'id'>
  >;
  resyncPlan?: Resolver<
    ResolversTypes['SubscriptionPlan'],
    ParentType,
    ContextType,
    RequireFields<MutationResyncPlanArgs, 'id'>
  >;
  runNow?: Resolver<
    ResolversTypes['SubscriptionContract'],
    ParentType,
    ContextType,
    RequireFields<MutationRunNowArgs, 'id'>
  >;
  unarchivePlan?: Resolver<
    ResolversTypes['SubscriptionPlan'],
    ParentType,
    ContextType,
    RequireFields<MutationUnarchivePlanArgs, 'id'>
  >;
  updateContract?: Resolver<
    ResolversTypes['SubscriptionContract'],
    ParentType,
    ContextType,
    RequireFields<MutationUpdateContractArgs, 'id' | 'input'>
  >;
  updatePlan?: Resolver<
    ResolversTypes['SubscriptionPlan'],
    ParentType,
    ContextType,
    RequireFields<MutationUpdatePlanArgs, 'id' | 'input'>
  >;
}>;

export type PlanFrequencyResolvers<
  ContextType = GraphQLContext,
  ParentType extends ResolversParentTypes['PlanFrequency'] =
    ResolversParentTypes['PlanFrequency'],
> = ResolversObject<{
  ...
  prepaidBillingInterval?: Resolver<
...
> = ResolversObject<{
  collections?: Resolver<
    Array<ResolversTypes['ShopifyCollection']>,
    ParentType,
    ContextType,
    RequireFields<QueryCollectionsArgs, 'first'>
  >;
  ...
  >;
  plans?: Resolver<
    Array<ResolversTypes['SubscriptionPlan']>,
    ParentType,
    ContextType,
    RequireFields<QueryPlansArgs, 'shopId'>
  >;
  searchProducts?: Resolver<
    Array<ResolversTypes['ShopifyProduct']>,
    ParentType,
    ContextType,
    RequireFields<QuerySearchProductsArgs, 'first' | 'query'>
  >;
  storefrontWidget?: Resolver<
    ResolversTypes['StorefrontWidget'],
    ParentType,
    ContextType
  >;
}>;

export type ShopifyCollectionResolvers<
  ContextType = GraphQLContext,
  ParentType extends ResolversParentTypes['ShopifyCollection'] =
    ResolversParentTypes['ShopifyCollection'],
> = ResolversObject<{
...
export type ShopifyProductResolvers<
  ContextType = GraphQLContext,
  ParentType extends ResolversParentTypes['ShopifyProduct'] =
    ResolversParentTypes['ShopifyProduct'],
> = ResolversObject<{
  featuredImageUrl?: Resolver<
  ...
  title?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  variants?: Resolver<
    Array<ResolversTypes['ShopifyProductVariant']>,
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type ShopifyProductVariantResolvers<
  ContextType = GraphQLContext,
  ParentType extends ResolversParentTypes['ShopifyProductVariant'] =
    ResolversParentTypes['ShopifyProductVariant'],
> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
...
export type StorefrontWidgetResolvers<
  ContextType = GraphQLContext,
  ParentType extends ResolversParentTypes['StorefrontWidget'] =
    ResolversParentTypes['StorefrontWidget'],
> = ResolversObject<{
  ...
  source?: Resolver<
    Maybe<ResolversTypes['StorefrontWidgetSource']>,
    ParentType,
    ContextType
  >;
  status?: Resolver<
    ResolversTypes['StorefrontWidgetStatus'],
    ParentType,
    ContextType
  >;
  themeName?: Resolver<
...
export type SubscriptionContractResolvers<
  ContextType = GraphQLContext,
  ParentType extends ResolversParentTypes['SubscriptionContract'] =
    ResolversParentTypes['SubscriptionContract'],
> = ResolversObject<{
  ...
  >;
  boxItems?: Resolver<
    Maybe<Array<ResolversTypes['BoxItem']>>,
    ParentType,
    ContextType
  >;
  cancellationNotes?: Resolver<
    Maybe<ResolversTypes['String']>,
    ParentType,
    ContextType
  >;
  ...
  >;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  lastBillingAttemptId?: Resolver<
    Maybe<ResolversTypes['String']>,
    ParentType,
    ContextType
  >;
  lastBillingDate?: Resolver<
    Maybe<ResolversTypes['String']>,
    ParentType,
    ContextType
  >;
...
export type SubscriptionPlanResolvers<
  ContextType = GraphQLContext,
  ParentType extends ResolversParentTypes['SubscriptionPlan'] =
    ResolversParentTypes['SubscriptionPlan'],
> = ResolversObject<{
  boxConfig?: Resolver<
    Maybe<ResolversTypes['BoxConfig']>,
    ParentType,
    ContextType
  >;
  ...
  description?: Resolver<
    ...
    ContextType
  >;
  frequencies?: Resolver<
    Array<ResolversTypes['PlanFrequency']>,
    ParentType,
    ContextType
  >;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  ...
  shopId?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  shopifySellingPlanGroupId?: Resolver<
    Maybe<ResolversTypes['String']>,
    ParentType,
    ContextType
  >;
