...
| Symptom                                                     | Fix                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `The executable pnpm could not be found` (Create container) | Railway is running a `pnpm …` Start Command against an image that has no pnpm (admin/portal nginx, or API runner). **Preferred:** clear Custom Start Command so Dockerfile CMD is used (API: `node dist/index.js`; admin: nginx). Confirm `RAILWAY_DOCKERFILE_PATH=apps/admin/Dockerfile`. Admin image also ships a `pnpm` shim that boots nginx if the bad Start Command is still set — pull latest `apps/admin/Dockerfile` and redeploy. |
